# PainWatchStandard Dashboard Branch

This branch is the Git upload vehicle for the dashboard flow. It is
...
/opt/anaconda3/envs/thepipe/bin/python inference_flow/train_final_model.py
```
...
```bash
/opt/anaconda3/envs/thepipe/bin/python inference_flow/smoke_test.py
```
...
- `PainThermometer/Docs/MODEL_INFRA_AND_WATCH_COMPATIBILITY.md`
- `PainThermometer/Docs/COREML_MODEL_API.md`
- `PAIN_FEEDER_SPEC.md`
